...
>
    ...
    <span class="text-sm font-medium">
        Pengajuan
            ...
            {{-- MAIN MENU --}}
                ...
                {{-- PEGAWAI HANYA CUTI TAMBAHAN --}}

                <a
                    href="{{ route('cuti_tambahan.index') }}"
                    class="
                        flex
                        items-center
                        gap-4
    ...
    >
        ...
        @elseif($role === 'pegawai')
            ...
            {{-- PEGAWAI HANYA MEMILIKI CUTI TAMBAHAN --}}
